...
### En modalité conception :
 - utilisez **VSCode**, avec l'extension **PlatformIO**.
 - ouvrez le projet en ouvrant le fichier `espace de travail` (*workspace* en anglais) : "flashMacLine.code-workspace", situé en racine de ce dossier.
